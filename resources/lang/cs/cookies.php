...
return [
    ...
    'categories' => [
        ...
        'marketing' => [
            'title' => 'Marketingové',
            'description' => 'Tyto soubory cookie slouží k měření výkonu našich kampaní a k zobrazování reklamy, která je pro vás relevantní, zde i na jiných webových stránkách.',
        ],
    ],
    ...
    'defaults' => [
        ...
        '_fbp' => 'Používá se službou Meta (Facebook) k identifikaci prohlížeče pro účely měření reklamy a cílení.',
        '_fbc' => 'Ukládá informaci o posledním kliknutí na reklamu Meta (Facebook), díky které jste se dostali na naše stránky.',
        '_hjSessionUser' => 'Slouží službě Hotjar k rozpoznání stejného návštěvníka napříč návštěvami.',
        '_hjSession' => 'Slouží službě Hotjar k uchování dat o aktuální relaci návštěvníka.',
        '_hjFirstSeen' => 'Slouží službě Hotjar k rozlišení, zda jde o první návštěvu.',
        '_hjAbsoluteSessionInProgress' => 'Slouží službě Hotjar k měření prvního zobrazení stránky v relaci.',
        'sklik' => 'Slouží službě Seznam Sklik k retargetingu a měření výkonu reklamních kampaní.',
    ],
];
